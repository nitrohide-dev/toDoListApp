...
//    constructors
   ...
   public Board(String title, String key, boolean locked,List<TaskList> taskLists) {
        this.key = key;
        this.title = title;
    ...
    public Board(String title, String key, boolean locked,int password,List<TaskList> taskLists) {
        this.key = key;
        this.title = title;
        this.taskLists = taskLists;
        this.locked = locked;
